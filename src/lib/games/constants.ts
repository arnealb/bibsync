 ...
 * (Flappy / Tetris / 2048 / Pet Connect / USA Staten / each Minesweeper
 * difficulty). Keep in sync with the 500 in
 * supabase/migrations/0051_game_kings.sql and its replacements
 * (0060/0063/0064).
 */
