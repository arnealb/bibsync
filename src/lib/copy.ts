...
export const copy = {
  ...
  lottery: {
    title: "Loterij",
    subtitle: "Koop tickets, de pot groeit en één winnaar pakt alles.",
    stat: "Jouw bibcoins",
    cantAfford: "Niet genoeg bibcoins voor zoveel tickets.",
    unavailable: "De loterij is even niet beschikbaar.",
    busy: "Even te snel — probeer opnieuw.",
    closed: "De trekking loopt — wacht op de volgende ronde.",
    needPlayers: "Er zijn minstens 2 deelnemers nodig.",
    needTicket: "Koop eerst een ticket.",
    potLabel: "Pot",
    ...
    endsIn: (s: number) => `Trekking in ${s}s`,
    waitingPlayers: "Wachten op een 2e deelnemer…",
    ...
    winner: (name: string, prize: number) =>
      `🎉 ${name} wint de pot van ${prize} bibcoins!`,
