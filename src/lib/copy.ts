...
export const copy = {
  ...
  horses: {
    ...
    raceClosed: "De inzetten voor deze race zijn al gesloten.",
    noRace: "Er staat nog geen race klaar — kom straks terug.",
    nextRaceAt: (time: string) => `Race om ${time}`,
    ...
    pool: (n: number) => `${n} in de pot`,
    betsTitle: "Inzetten op deze race",
    noBets: "Nog geen inzetten — wees de eerste!",
    yourBet: "jij",
    lastRace: "Vorige race",
    finishOrder: "Uitslag",
    wonBadge: (n: number) => `+${n}`,
    lostBadge: "verloren",
    ...
    commentary: {
      start: "Daar gaan ze! 🏇",
      leading: (name: string) => `${name} ligt aan kop!`,
      closing: (name: string) => `${name} vliegt naar de finish!`,
      wins: (name: string) => `${name} wint de race! 🏁`,
    },
    colors: {
      red: "Rood",
      blue: "Blauw",
  ...
  mexen: {
    title: "Mexen",
    subtitle:
      "Pietjesbak met 2 dobbelstenen — gooi om beurten, de laagste worp drinkt.",
    stat: "Jouw bibcoins",
    unavailable: "Mexen is even niet beschikbaar.",
    notMember: "Beide spelers moeten lid zijn van deze kamer.",
    settleFailed: "Inzet verrekenen lukte niet (te weinig bibcoins?).",
    setup: {
      heading: "Nieuw potje",
      players: "Spelers",
      playersHint: "Kies wie er meedoet (2–10).",
      selected: (n: number) => `${n} gekozen`,
      rounds: "Aantal rondes",
      bet: "Met bibcoin-inzet",
      betHint: "De verliezer van elke ronde betaalt de winnaar.",
      stake: "Inzet per ronde",
      start: "Start potje",
      needPlayers: "Kies minstens 2 spelers.",
    },
    round: (n: number, total: number) => `Ronde ${n} / ${total}`,
    turnOf: (name: string) => `Beurt van ${name}`,
    throwsLeft: (n: number) => `${n} ${n === 1 ? "worp" : "worpen"} over`,
    firstSetsThrows: "De eerste speler bepaalt hoeveel worpen iedereen krijgt.",
    rollHint:
      "Gooi, klik een steen aan om hem te laten liggen, en gooi de rest opnieuw.",
    roll: "Gooi",
    rolling: "Gooien…",
    reroll: "Gooi opnieuw",
    keep: "Laten liggen",
    stop: "Klaar",
    honderdman: (name: string) => `🥴 Honderdman: ${name}`,
    fx: {
      mexen: "Mexen! 🌮",
      becameHonderdman: (name: string) => `${name} is nu honderdman 🥴`,
      drink: (n: number) => `drinkt ${n} ${n === 1 ? "slok" : "slokken"}`,
      honderdmanDrinks: (name: string, n: number) =>
        `honderdman ${name} drinkt ${n} ${n === 1 ? "slok" : "slokken"}`,
      dealHalf: "mag een half atje uitdelen",
    },
    results: {
      heading: "Ronde-uitslag",
      winner: (name: string) => `🏆 Hoogste: ${name}`,
      loser: (name: string, atjes: number) =>
        `🍺 Laagste: ${name} — ${atjes} ${atjes === 1 ? "atje" : "atjes"}`,
      tie: "Gelijkspel — niemand betaalt.",
      paid: (loser: string, winner: string, n: number) =>
        `${loser} betaalt ${n} bibcoins aan ${winner}.`,
      nextRound: "Volgende ronde",
      finish: "Bekijk eindstand",
    },
    summary: {
      heading: "Eindstand",
      losses: (n: number) => `${n}× verloren`,
      net: (n: number) => (n >= 0 ? `+${n} bibcoins` : `${n} bibcoins`),
      again: "Nog een potje",
    },
  },
  usstates: {
  ...
  voetbal: {
    title: "Voetbal ⚽",
    subtitle:
      "Noem zoveel mogelijk voetballers voor de tijd om is. Elke juiste = bibcoins.",
    chooseList: "Kies een lijst",
    start: "Start ronde",
    restart: "Nieuwe ronde",
    placeholder: "Typ een voetballer…",
    submit: "Raad",
    timeLeft: (s: number) => `${s}s`,
    progress: (found: number, total: number) => `${found}/${total} geraden`,
    needed: (n: number) => `${n} nodig om te winnen`,
    coinsGained: (n: number) => `+${n}`,
    correct: "Juist! ⚽",
    already: "Die had je al!",
    wrong: "Nope, geen match…",
    capped: "Uurlimiet bereikt — straks meer.",
    win: "Gewonnen! 🎉",
    winSub: (n: number) => `Je verdiende ${n} bibcoins deze ronde.`,
    lose: "Tijd om!",
    loseSub: (found: number, need: number) =>
      `Je raadde er ${found}. Je had er ${need} nodig om te winnen — volgende keer beter!`,
    reveal: "De rest was:",
    reward: (n: number) => `Elke voetballer die je raadt levert ${n} bibcoins op.`,
    unavailable: "Voetbal is even niet beschikbaar. Probeer later opnieuw.",
    hubSubtitle: "Kies een spel en verdien bibcoins met je voetbalkennis.",
    chooseGame: "Kies een spel",
    back: "← Ander spel",
    modes: {
      namen: { label: "Namen raden", desc: "Noem zoveel mogelijk spelers in 120s." },
      hogerlager: { label: "Hoger of Lager", desc: "Raad wie de hoogste marktwaarde heeft." },
      quiz: { label: "Voetbalquiz", desc: "Multiplechoice trivia — hoeveel weet jij?" },
      mystery: { label: "Raad de speler", desc: "Ontrafel de mysterieuze voetballer." },
    },
    hl: {
      streak: (n: number) => `Reeks: ${n}`,
      best: (n: number) => `Beste: ${n}`,
      value: (n: number) => `€${n}M`,
      higher: "Hoger ⬆️",
      lower: "Lager ⬇️",
      prompt: "Heeft deze speler een hogere of lagere marktwaarde?",
      correct: "Juist! ⚽",
      wrong: "Mis! Reeks voorbij.",
      next: "Volgende",
      retry: "Opnieuw",
    },
    quiz: {
    ...
    mystery: {
      ...
      placeholder: "Welke speler is dit?",
      guess: "Raad",
      hint: "Meer hints",
      giveUp: "Geef op",
      solved: (name: string) => `Correct — het was ${name}! ⚽`,
      revealed: (name: string) => `Het was ${name}.`,
      wrong: "Nope, probeer nog eens…",
      next: "Nieuwe speler",
    },
  },
  steps: {
  ...
  games: {
    ...
    shameMsgs: [
      "Zelfs mijn oma scoort hoger dan dit. 👵",
      "Pathetic. Maar lief geprobeerd. 💀",
      "Dat record van jezelf was dus heiliger dan jij. 🏛️",
      "Misschien is studeren toch je roeping...",
      "Hopeloos. Gewoon hopeloos. 💅",
      "Probeer het volgende keer met twee handen.",
      "Je record staat steviger dan jij ooit zal staan.",
      "Zelfs de boekenkast lacht je nu uit. 📚",
      "Terug naar square one, schat. 🫠",
      "Dit gaat écht nooit beter worden, hè? 😬",
      "Beschamend. Er is geen ander woord voor.",
      "Je vorige ik had meer in zijn mars dan jij nu.",
      "En toch ben je blij dat niemand dit zag? Ik zag het.",
      "Faal met flair, zeggen ze. Dit was alleen maar faal.",
      "Ik hoop voor jou dat dit een slechte dag was.",
    ],
    shameClose: "Tik om te sluiten",
    snake: {
      title: "Snake",
    ...
    dino: {
      title: "Dino Runner",
      subtitle:
        "Het Chrome-spel zonder wifi — spring over cactussen. Coins per obstakel (gedeelde uurcap).",
      score: "Score",
      best: "Record",
      tapToStart: "Tik of spatie om te springen — ↓ om te bukken",
      gameOver: "Game over",
      restart: "Opnieuw",
      saved: (n: number) => `Score ${n} opgeslagen`,
      newBest: "Nieuw record! 🎉",
